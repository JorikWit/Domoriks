...
//		{{pin,    port,             value,min,max} init_func, update_func}
		...
		{{B2_Pin,(const int)B2_GPIO_Port,0,0,1}, &init_di, &read_di},
		{{B3_Pin,(const int)B3_GPIO_Port,0,0,1}, &init_di, &read_di},
//		{{pin,    port,             value,min,max} init_func, update_func}
		{{B4_Pin,(const int)B4_GPIO_Port,0,0,1}, &init_di, &read_di},
		{{B5_Pin,(const int)B5_GPIO_Port,0,0,1}, &init_di, &read_di},
		{{B6_Pin,(const int)B6_GPIO_Port,0,0,1}, &init_di, &read_di}
//		{{pin,    port,             value,min,max} init_func, update_func}
};
